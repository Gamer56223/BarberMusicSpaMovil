...
export const listarEspecialidades = async () => {
    try {
        const response = await api.get("/Admin_especialidades/especialidades");
...
export const DetalleEspecialidadId = async (id) => {
    try {
        const response = await api.get(`/Admin_especialidades/especialidades/${id}`);
...
export const eliminarEspecialidad = async (id) => {
    ...
    try {
        const response = await api.delete(`/Admin_especialidades/especialidades/${id}`);
...
export const crearEspecialidad = async (data) => {
    try {
        const response = await api.post("/Admin_especialidades/especialidades", data);
...
export const editarEspecialidad = async (id, data) => {
    try {
        const response = await api.put(`/Admin_especialidades/especialidades/${id}`, data);

...
//     try {
//         const response = await api.get("/listarSucursales");
...
//     try {
//         const response = await api.get(`listarSucursales/${id}`);
...
//     try {
//         const response = await api.delete(`/eliminarSucursal/${id}`);
//         console.log("Respuesta eliminarSucursal:", response.data);
//         return { success: true, message: response.data.message || "Excepcion Sucursal eliminada correctamente" };
//     } catch (error) {
//         const errorMessage = error.response ? formatErrorMessage(error.response.data) : "Error de conexión";
...
//     try {
//         const response = await api.post("/crearSucursal", data);
...
//     try {
//         const response = await api.put(`/editarSucursal/${id}`, data);

...
//     try {
//         const response = await api.get("/listarProductos");
...
//     try {
//         const response = await api.get(`listarProductos/${id}`);
...
//     try {
//         const response = await api.delete(`/eliminarProducto/${id}`);
//         console.log("Respuesta eliminarProducto:", response.data);
//         return { success: true, message: response.data.message || "Excepcion Producto eliminado correctamente" };
//     } catch (error) {
//         const errorMessage = error.response ? formatErrorMessage(error.response.data) : "Error de conexión";
...
//     try {
//         const response = await api.post("/crearProducto", data);
...
//     try {
//         const response = await api.put(`/editarProducto/${id}`, data);

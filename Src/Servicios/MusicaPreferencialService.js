...
//     try {
//         const response = await api.get("/listarMusicaPreferenciales");
...
//     try {
//         const response = await api.get(`listarMusicaPreferenciales/${id}`);
...
//     try {
//         const response = await api.delete(`/eliminarMusicaPreferencial/${id}`);
...
//     try {
//         const response = await api.post("/crearMusicaPreferencial", data);
...
//     try {
//         const response = await api.put(`/editarMusicaPreferencial/${id}`, data);

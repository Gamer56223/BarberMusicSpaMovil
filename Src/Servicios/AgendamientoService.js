...
//     try {
//         const response = await api.get(`listarAgendamientos/${id}`);
//         console.log("Respuesta DetalleAgendamientos:", response.data);
//         return { success: true, data: response.data };
//     } catch (error) {
//         const errorMessage = error.response ? formatErrorMessage(error.response.data) : "Error de conexión";
...
// export const crearAgendamiento = async (data) => {
//     try {
//         const response = await api.post("/crearAgendamiento", data);
//         console.log("Respuesta crearAgendamiento:", response.data);
//         return { success: true, data: response.data };
//     } catch (error) {
//         const errorMessage = error.response ? formatErrorMessage(error.response.data) : "Error de conexión";

...
//                 <Text style={styles.detalle}><Text style={styles.detalleLabel}>Dirección:</Text> {especialidad.Descripcion}</Text>
//                 <Text style={styles.detalle}><Text style={styles.detalleLabel}>Teléfono:</Text> {especialidad.IconoClave}</Text>
//                 <Text style={styles.detalle}><Text style={styles.detalleLabel}>Nit:</Text> {especialidad.Activo}</Text>
//             </View>

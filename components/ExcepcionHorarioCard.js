...
// import styles from '../Styles/ExcepcionHorarioCardStyles';

// function ExcepcionHorarioCard({ excepcionhorario, nombreSucursal, onEdit, onDelete, onDetail }) {
//     return (
//         <View style={styles.card}>
//             <View style={styles.info}>
//                 <Text style={styles.nombre}>{eps.Nombre}</Text>
//                 <Text style={styles.detalle}><Text style={styles.detalleLabel}>Fecha:</Text> {eps.Fecha}</Text>
//                 <Text style={styles.detalle}><Text style={styles.detalleLabel}>Esta Cerrado:</Text> {eps.EstaCerrado}</Text>
...
// export default React.memo(ExcepcionHorarioCard);